...
import SupplementLogos from "../components/logos/SupplementsLogos"

const MedicareSupplements = () => {
  const data = useStaticQuery(graphql`
    query {
      productItem: productsJson(slug: { eq: "medicare-supplements" }) {
        id
        slug
        product
        productImage {
...
export default MedicareSupplements
