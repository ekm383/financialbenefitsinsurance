    ...
    <MedicareWrapper>
      <Section style={{ margin: "4rem auto" }}>
        <div className="box">
          ...
          <p>
            It is the largest healthcare payer in the United States, In fact, it
            covers over 60 million people. You become eligible for Medicare when
            you turn 65. You may also become eligible before you turn 65. This
            is usually due to having end-stage renal disease at any age, or also
            if you are under 65 with certain disabilities.
          </p>
          <p>
            ...
            procedures, and hospital stays. The Centers for Medicare & Medicaid
            Services or CMS governs both Medicare and Medicaid. CMS is a branch
        ...
        <div className="box">
          ...
          <ul>
            <li>
              ...
              income taxes paid on social security benefits, interest earned on
              the fund’s investments, and Part A premiums from those that don’t
              qualify for free Part A.
            </li>
            <li>
              Supplementary Medical Insurance Trust Fund: funds Part B, Part D,
              and program administration. This trust is funded mostly by Part B
              and Part D premiums, funds that Congress authorizes, and trust
              fund earned interest.
            </li>
          </ul>
        </div>
        <div className="box">
          ...
          <p>
            You may face a late enrollment penalty for Part B, or Part D if you
            are eligible and choose not to enroll during your initial enrollment
            period. Make sure you have creditable coverage if you are
            considering delaying enrollment for either parts.
          </p>
        </div>
        <div className="box">
          ...
          <p>
            ...
            will usually begin on the 1st of the month that you turn 65. This
            also applies to you if you are auto-enrolled due to receiving
            benefits from social security or RRB. However, your coverage will
            begin on the 1st of the previous month of your birthday if your
            birthday is on the first of the month.
          </p>
          <ul>
            <li>
              Example 1: Bill is turning 65 July 20. He enrolls in Medicare
              within the 3 months before the month he turns 65. Bill’s coverage
              will start July 1st.
            </li>
            <li>
          ...
          <p>
            If you’re under 65 with a disability, your coverage will start after
            you receive Social Security disability benefits. This is also true
            if you receive some RRB disability benefits for at least 24 months.
          </p>
          <p>
        ...
        <div className="box">
          ...
          <p>
            If you choose Original Medicare, it will consist of Part A and Part
            B. This is also known as Traditional Medicare or Fee-for-Service
            (FFS) Medicare. It is governed by the Centers for Medicare and
            Medicaid Services (CMS). If you go this route, you will most likely
            need to choose a stand-alone Part D (Prescription Drug) plan.
          </p>
        </div>
        <div className="box">
          ...
          <div className="column">
            <div>
              ...
              <ul>
                ...
                <li>
                  Medicare is your primary payer, therefore the government pays
                  directly for your claims.
                </li>
                <li>
            ...
            <div>
              ...
              <ul>
                <li>
                  ...
                  you will likely be more limited in your choice of doctors and
                  hospitals. With the PPO plans you can go outside of the
                ...
                <li>
                  Premiums for an Advantage plan can be very low cost. However,
                  you are still responsible for your monthly Part B premium
                  which is $144.60 per month for most people in 2020. You must
                  also still pay for your Part A premium, if you have one.
                </li>
                <li>
                ...
                <li>
                  ...
                  Medicare does not cover. Examples include dental, vision, and
                  hearing coverage.
                </li>
              </ul>
            </div>
        ...
        <div className="box">
          <p>
            ...
            phone call away! I am a licensed Independent Broker. Therefore, I am
            not loyal to any one specific insurance company. Above all, my
            loyalty is to my clients. Best of all, my services are 100% free of
            charge!
          </p>
        </div>
      </Section>
