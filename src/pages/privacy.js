  ...
  return (
    <Layout>
      <Section style={{ margin: "4rem auto" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Financial Benefits Insurance, 1311
              Kapiolani Blvd 504 Honolulu, HI 96814.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Hawaii, United States
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Financial Benefits Insurance,
              accessible from{" "}
              <a
                href="fbihi.com"
        ...
        <ul>
          <li>By phone number: 808.792.5194</li>
        </ul>
      </Section>
    </Layout>
  )
